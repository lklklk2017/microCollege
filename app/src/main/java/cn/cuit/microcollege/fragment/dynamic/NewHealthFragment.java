...
import cn.cuit.microcollege.presenter.newfragments.NewHealthFragmentPresenter;
 ...
 */
public class NewHealthFragment extends BaseFragment<NewHealthFragmentPresenter> implements
        NewHealthFragmentContract.View, NewHotAdapter.OnItemClickListener,
        SwipeRefreshLayout.OnRefreshListener{


    @BindView(R.id.fragment_new_health_rcy)
    RecyclerView mRcy;
    Unbinder unbinder;
    @BindView(R.id.fragment_new_health_result)
    LinearLayout mNoResultLyt;
    private NewHotAdapter mAdapter;
    private int currPage = 1;
    private LinearLayoutManager mLinManager;

    public NewHealthFragment() {
    }

    public static NewHealthFragment newInstance(Bundle bundle) {
        NewHealthFragment currfragment = new NewHealthFragment();
        if (bundle != null) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.fragment_new_health, container, false);
        setCreatedView(inflate);
        ((CustomViewPager) getViewPager()).setObjectForPosition(inflate, 3);
        unbinder = ButterKnife.bind(this, inflate);
        return inflate;
    }

    @Override
    public NewHealthFragmentPresenter initPresenter() {
        return new NewHealthFragmentPresenter(this);
    }
