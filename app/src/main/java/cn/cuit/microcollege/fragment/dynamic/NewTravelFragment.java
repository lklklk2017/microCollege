...
import cn.cuit.microcollege.presenter.newfragments.NewTravelFragmentPresenter;
 ...
 */
public class NewTravelFragment extends BaseFragment<NewTravelFragmentPresenter> implements
        NewTravelFragmentContract.View, NewHotAdapter.OnItemClickListener,
        SwipeRefreshLayout.OnRefreshListener {


    @BindView(R.id.fragment_new_travel_rcy)
    RecyclerView mRcy;
    Unbinder unbinder;
    @BindView(R.id.fragment_new_travel_result)
    ...
    public static NewTravelFragment newInstance(Bundle bundle) {
        NewTravelFragment currfragment = new NewTravelFragment();
        if (bundle != null) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.fragment_new_travel, container, false);
        setCreatedView(inflate);
        ((CustomViewPager) getViewPager()).setObjectForPosition(inflate, 4);
        unbinder = ButterKnife.bind(this, inflate);
        return inflate;
    }

    @Override
    public NewTravelFragmentPresenter initPresenter() {
        return new NewTravelFragmentPresenter(this);
    }
