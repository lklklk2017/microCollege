...
import cn.cuit.microcollege.presenter.newfragments.NewInternetFragmentPresenter;
 ...
 */
public class NewInternetFragment extends BaseFragment<NewInternetFragmentPresenter> implements
        NewInternetFragmentContract.View, NewHotAdapter.OnItemClickListener,
        SwipeRefreshLayout.OnRefreshListener {


    @BindView(R.id.fragment_new_internet_rcy)
    RecyclerView mRcy;
    Unbinder unbinder;
    @BindView(R.id.fragment_new_internet_result)
    LinearLayout mNoResultLyt;
    private NewHotAdapter mAdapter;
    private int currPage = 1;
    private LinearLayoutManager mLinManager;

    public NewInternetFragment() {
    }

    public static NewInternetFragment newInstance(Bundle bundle) {
        NewInternetFragment currfragment = new NewInternetFragment();
        if (bundle != null) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.fragment_new_internet, container, false);
    ...
    @Override
    public NewInternetFragmentPresenter initPresenter() {
        return new NewInternetFragmentPresenter(this);
    }
