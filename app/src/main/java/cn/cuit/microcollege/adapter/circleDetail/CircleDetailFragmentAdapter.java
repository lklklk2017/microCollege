package cn.cuit.microcollege.adapter.circleDetail;
 ...
 * @Date: 2019/4/23
 * @Descirption: circleDetail-fragment-Hot/New
 */
public class CircleDetailFragmentAdapter extends BaseRcyAdapter<GetDynamicWithCircleResultBean.TrendsBean, RecyclerView.ViewHolder> {

    public CircleDetailFragmentAdapter() {
        super();
    }

    public CircleDetailFragmentAdapter(List<GetDynamicWithCircleResultBean.TrendsBean> list) {
...
//        return 0;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (itemViewType == 0) {//零布局
            ...
            //circle tag
//            final GetDynamicWithCircleResultBean.TrendsBean.CircleBean circle = trendsBean.getCircle();
//            if (circle != null) {
...
//            }
        ...
        if (itemViewType == 1) {
            ...
            /*********************************init img end*****************************************/
            //circle tag
//            GetDynamicWithCircleResultBean.TrendsBean.CircleBean circle = trendsBean.getCircle();
//            if (circle != null) {
//                int circleId = circle.getCircleId();
//                if (circleId != 0) {
//                    //有圈子
