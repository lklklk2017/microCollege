 ...
 */
public class HomePageThreeAdapter extends BaseRcyAdapter<GetDynamicWithCircleResultBean.TrendsBean, RecyclerView.ViewHolder> {

    public HomePageThreeAdapter() {
        super();
    }

    public HomePageThreeAdapter(List<GetDynamicWithCircleResultBean.TrendsBean> list) {
