 ...
 */
public class CircleSearchAdapter extends BaseRcyAdapter<GetMyCircleResultBean.CirclesBean, CircleSearchAdapter.MyCircleViewHolder> {
    ...
    public CircleSearchAdapter(List<GetMyCircleResultBean.CirclesBean> list) {
        super(list);
    }
    ...
    public MyCircleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = getInflater(parent).inflate(R.layout.fragment_search_detail_circle_item, parent, false);
    ...
    class MyCircleViewHolder extends ViewHolder {
        @BindView(R.id.fragment_search_detail_circle_item_portrait)
        ImageView mPortraitImg;
        @BindView(R.id.fragment_search_detail_circle_item_circle_name)
        TextView mCircleNameTv;
        @BindView(R.id.fragment_search_detail_circle_item_circle_title)
        TextView mCircleTitleTv;
        @BindView(R.id.fragment_search_detail_circle_item_circle_option)
