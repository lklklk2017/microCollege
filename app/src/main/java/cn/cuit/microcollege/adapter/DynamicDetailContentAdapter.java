 ...
 */
public class DynamicDetailContentAdapter extends BaseRcyAdapter<GetDynamicResultBean.TrendsBean, RecyclerView.ViewHolder> {

    public DynamicDetailContentAdapter() {
        super();
    }

    public DynamicDetailContentAdapter(List<GetDynamicResultBean.TrendsBean> list) {
