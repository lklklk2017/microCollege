 ...
 * @Descirption:
 */
public class GetDynamicResultBean implements Parcelable {

    protected GetDynamicResultBean(Parcel in) {
        message = in.readString();
        statusCode = in.readString();
    }

    public static final Creator<GetDynamicResultBean> CREATOR = new Creator<GetDynamicResultBean>() {
        @Override
        public GetDynamicResultBean createFromParcel(Parcel in) {
            return new GetDynamicResultBean(in);
        }

        @Override
        public GetDynamicResultBean[] newArray(int size) {
            return new GetDynamicResultBean[size];
        }
    };

    @Override
    public String toString() {
        return "GetDynamicResultBean{" +
                "message='" + message + '\'' +
