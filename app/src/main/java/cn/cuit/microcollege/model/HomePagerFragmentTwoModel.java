 ...
 * @Descirption:
 */
public class HomePagerFragmentTwoModel implements HomePagerFragmentTwoContract.Model {
    @Override
    public void getDynamicInfo(Map<String, Object> data, final DynamicHttpResult result) {
        RetrofitManager.getAdminApiService().getDynamicWithCircleByCondiction(data)
